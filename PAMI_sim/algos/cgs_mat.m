function [x,flag,relres,iter,resvec] = cgs_mat(A,b,tol,maxit,M1,M2,x0,varargin)
...
n2b = norm(b,'fro');                     % Norm of rhs vector, b
if (n2b == 0)                      % if    rhs vector is all zeros
    x = zeros(n,size(b,2));                % then  solution is all zeros
...
resvec = zeros(maxit+1,size(b,2));         % Preallocate vector for norms of residuals
