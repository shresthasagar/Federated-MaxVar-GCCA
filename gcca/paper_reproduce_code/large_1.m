...
for inner_it_idx=1:length(inner_iters)
    ...
    for trial = 1:TotalTrial
        ...
        % % Ditributed MAX-VAR GCCA with warm start
        % disp(['Distributed with warm start ...'])
        % [Q1, G_1, obj_warm_distr_sgd{inner_it_idx}(trial,:), ~, St1, t_warm_distr_sgd] = LargeGCCA_distributed_stochastic(X,  K, ...
        %                                                                     'G_ini',G_ini, ...
        %                                                                     'Q_ini',Q_ini, ...
        %                                                                     'r',r, ...
        %                                                                     'algo_type','plain', ...
        ...
        % comm_cost_iter_distr_sgd{inner_it_idx}(1) = initial_comm_cost + per_iter_distr;
        % for i=2:length(obj_warm_distr_sgd{inner_it_idx}(1,:))
        %     comm_cost_iter_distr_sgd{inner_it_idx}(i) = comm_cost_iter_distr_sgd{inner_it_idx}(i-1) + per_iter_distr;
        % end 
    end  
end
